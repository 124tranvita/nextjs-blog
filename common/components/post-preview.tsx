...
export default function PostPreview({ previewData }: Props) {
  const src = useMemo(() => {
    return previewData.localImg
      ? previewData.localImg
      : previewData.cloudImg
      ? previewData.cloudImg
      : noImagePlaceholder;
  }, [previewData.cloudImg, previewData.localImg]);
